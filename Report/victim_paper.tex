...
The change in fire dynamics that resulted from fire department suppression indicated that the method of suppression did not have a significant effect on the rate at which conditions began to improve for the majority of the structure, although the combination of ventilation and suppression was beneficial to areas of the structure remote from the seat of the fire. Outlier experiments, such as Experiments 3 and 5, indicated that in order for suppression to be effective, whether from the interior or the exterior, a sufficient amount of water must ab applied to the burning contents of the room. After deploying their attack line, the crews conducting transitional attacks were able to immediately apply water to the fire, resulting in water application significantly faster than the interior attack groups. Once the interior attack groups deployed their hose line, they were often delayed while waiting for the search crew to simulate forcing entry into the building. Despite the delay, the interior attack groups entered the structure significantly faster (174$\pm$10 s) when compared to the transitional attack groups (213$\pm$29 s) (p=0.02).
